...
local degreeOnehundredInterpolationEvaluatedAtAThousandPoints =
	Interpolation.Chebyshev.evaluateAtPointList(stepFunction, thousandPointGrid, 100)
...
print(
	"Error: "
		.. tostring(
			Tools.list.error(
				degreeOnehundredInterpolationEvaluatedAtAThousandPoints,
				Tools.list.map(stepFunction, thousandPointGrid)
			)
		)
)
print()
...
mark1 = os.clock()
degreeOnehundredInterpolationEvaluatedAtAThousandPoints =
	Interpolation.Chebyshev.evaluateAtPointList(polynomial, thousandPointGrid, 100)
print(Tools.list.tostring(degreeOnehundredInterpolationEvaluatedAtAThousandPoints))
...
mark1 = os.clock()
degreeOnehundredInterpolationEvaluatedAtAThousandPoints =
	Interpolation.Chebyshev.evaluateAtPointList(exponential, thousandPointGrid, 100)
mark2 = os.clock()
...
print(
	"Error: "
		.. tostring(
			Tools.list.error(
				degreeOnehundredInterpolationEvaluatedAtAThousandPoints,
				Tools.list.map(exponential, thousandPointGrid)
			)
		)
)
print()
...
mark1 = os.clock()
local degreeOnehundredInterpolationEvaluatedAtAHundredPoints =
	Interpolation.Chebyshev.evaluateAtPointList(exponential, hundredPointGrid, 100)
mark2 = os.clock()
...
print(
	"Error: "
		.. tostring(
			Tools.list.error(
				degreeOnehundredInterpolationEvaluatedAtAHundredPoints,
				Tools.list.map(exponential, hundredPointGrid)
			)
		)
)
print()
mark1 = os.clock()
local degreeTenInterpolationEvaluatedAtAHundredPoints =
	Interpolation.Chebyshev.evaluateAtPointList(exponential, hundredPointGrid, 10)
mark2 = os.clock()
...
print(
	"Error: "
		.. tostring(
			Tools.list.error(
				degreeTenInterpolationEvaluatedAtAHundredPoints,
				Tools.list.map(exponential, hundredPointGrid)
			)
		)
)
...
local splineArcLength = function(x)
	return math.sqrt((4 * x ^ 2 - 2 * x + 1) ^ 2 + (x ^ 2 - 12) ^ 2 + (x ^ 2 + x + 1) ^ 2)
end
mark1 = os.clock()
degreeOnehundredInterpolationEvaluatedAtAThousandPoints =
	Interpolation.Chebyshev.evaluateAtPointList(splineArcLength, thousandPointGrid, 100)
mark2 = os.clock()
...
print(
	"Error: "
		.. tostring(
			Tools.list.error(
				degreeOnehundredInterpolationEvaluatedAtAThousandPoints,
				Tools.list.map(splineArcLength, thousandPointGrid)
			)
		)
)
print()
...
mark1 = os.clock()
degreeOnehundredInterpolationEvaluatedAtAHundredPoints =
	Interpolation.Chebyshev.evaluateAtPointList(splineArcLength, hundredPointGrid, 100)
mark2 = os.clock()
...
print(
	"Error: "
		.. tostring(
			Tools.list.error(
				degreeOnehundredInterpolationEvaluatedAtAHundredPoints,
				Tools.list.map(splineArcLength, hundredPointGrid)
			)
		)
)
print()
mark1 = os.clock()
degreeTenInterpolationEvaluatedAtAHundredPoints =
	Interpolation.Chebyshev.evaluateAtPointList(splineArcLength, hundredPointGrid, 10)
mark2 = os.clock()
...
print()
mark1 = os.clock()
local spring = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({ 1, 8, 1 }, function(x)
	return 0
end, { -1, 1 }, { 1, 0 }, 32)
mark2 = os.clock()
...
print()
mark1 = os.clock()
spring = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({ 1, 32, 1 }, function(x)
	return 0
end, { -1, 1 }, { 1, 0 }, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
...
print()
mark1 = os.clock()
local laplace = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({ -1, 0, 0 }, function(x)
	return 0
end, { -1, 1 }, { 1, 0 }, 32)
mark2 = os.clock()
...
print()
mark1 = os.clock()
spring = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({ 1, 1, 100 }, function(x)
	return x
end, { -1, 1 }, { 0, 0 }, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
...
print()
mark1 = os.clock()
spring = ODE.SpectralMethods.chebyshevSecondOrderInitialValueProblem({ 1, 32, 1 }, function(x)
	return 0
end, { -1, 1 }, { 0, 1 }, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
...
print()
mark1 = os.clock()
spring = ODE.SpectralMethods.chebyshevSecondOrderInitialValueProblem({ 1, 0, 10 }, function(x)
	return 0
end, { -1, 1 }, { 0, 0.5 }, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
...
print()
mark1 = os.clock()
spring = ODE.SpectralMethods.chebyshevSecondOrderInitialValueProblem({
	1,
	function(x)
		return x
	end,
...
print()
mark1 = os.clock()
spring = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({
	1,
	0,
	function(x)
		return -x
