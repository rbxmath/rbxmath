...
print()
mark1 = os.clock()
local spring  = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({1, 8, 1}, function (x) return 0 end, 1, 0, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
print("Time: " .. tostring(mark2 - mark1))
print()
mark1 = os.clock()
spring  = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({1, 32, 1}, function (x) return 0 end, 1, 0, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
print("Time: " .. tostring(mark2 - mark1))
print()
mark1 = os.clock()
local laplace  = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({-1, 0, 0}, function (x) return 0 end, 1, 0, 32)
mark2 = os.clock()
print(Tools.list.tostring(laplace))
print("Time: " .. tostring(mark2 - mark1))
print()
mark1 = os.clock()
spring  = ODE.SpectralMethods.chebyshevSecondOrderBoundaryValueProblem({1, 1, 100}, function (x) return x end, 0, 0, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
print("Time: " .. tostring(mark2 - mark1))
print()
mark1 = os.clock()
spring  = ODE.SpectralMethods.chebyshevSecondOrderInitialValueProblem({1, 32, 1}, function (x) return 0 end, 0, 1, 32)
mark2 = os.clock()
print(Tools.list.tostring(spring))
print("Time: " .. tostring(mark2 - mark1))
print()