...
mark1 = os.clock()
local sine = ODE.SpectralMethods.chebyshevFirstOrder(math.cos, math.sin(-1), math.sin(1), 32)
mark2 = os.clock()
print(diff3)
print()
...
print()
mark1 = os.clock()
local splineInterp  = ODE.SpectralMethods.chebyshevFirstOrder(spline, 0, 1, 32)
mark2 = os.clock()
print(Tools.list.tostring(splineInterp))
print("Time: " .. tostring(mark2 - mark1))
print("This has bad behaviour because it is fundamentally unsolvable.")
print()